...
### [10] [CECILIA: Using Flexible Photoionization Models to Accurately Measure Abundances without Auroral Lines](https://arxiv.org/abs/2609.22488)
...
### [11] [The Deep Learning Halo Definer: A Multimodal Framework for Halo Mass and Gas Fraction Inference on Galaxy Groups and Clusters](https://arxiv.org/abs/2609.22543)
...
### [12] [Balmer Absorption Series and Broad Metal Lines in Two Luminous Little Red Dots](https://arxiv.org/abs/2609.22623)
...
### [13] [Dust Growth in Evolving Filamentary Molecular Clouds: Signatures in Ionization, Resistivity, and Infrared Scattering](https://arxiv.org/abs/2609.22751)
...
### [14] [The magnetic field in the multi-phase interstellar medium of NGC 6946](https://arxiv.org/abs/2609.22811)
...
### [15] [Mid-Infrared Diagnostics of PAH Processing and Radiation Fields in M33 H II Regions with JWST/MIRI](https://arxiv.org/abs/2609.22846)
...
### [16] [The interplay between AGN photo-ionization, radio jet, and star formation in the z $\sim$ 3.5 radio galaxy 4C +03.24](https://arxiv.org/abs/2609.22859)
...
### [17] [Sulfur-bearing molecules in a sample of active star-forming cores](https://arxiv.org/abs/2609.23030)
...
### [18] [Star formation and morphological trends in the Antlia cluster: Probing environmental influence out to 5R200](https://arxiv.org/abs/2609.23140)
...
### [19] [Surveying the Universe in 4D: Beating Cosmic Variance with Wide-Field Slitless Spectroscopy from HST, JWST, Euclid, Roman, and Beyond](https://arxiv.org/abs/2609.23148)
...
### [20] [The assembly of bulge-dominated galaxies: two evolutionary channels traced through morphology, kinematics, and environment with a hybrid classification pipeline](https://arxiv.org/abs/2609.23246)
...
### [21] [Tracing Interstellar Gas in Quiescent Galaxies Using Na I D and Ca II H&K Absorption](https://arxiv.org/abs/2609.23288)
...
### [22] [The CAMELS-CROCODILE Simulation Suite: A New Cosmology--Astrophysics Playground for Machine Learning](https://arxiv.org/abs/2609.23982)
...
### [23] [Hierarchical Dynamics within Molecular Clouds: Type 4 Scaling Relations of Molecular Clouds in the Second Galactic Quadrant](https://arxiv.org/abs/2609.23302)
...
### [24] [A Sample of 459 Galaxy Groups Identified from the FAST All Sky HI Survey DR2](https://arxiv.org/abs/2609.24060)
*Z. S. Yuan,Z. L. Wen*
...
### [26] [StAGE: Stellar Archaeology-driven Galaxy Evolution II. Binary Black Hole Mergers in Quiescent Galaxies and their Star-forming Progenitors](https://arxiv.org/abs/2609.24222)
...
### [27] [On the Detectability and Measurement of Galactic Bars as a Function of Redshift](https://arxiv.org/abs/2609.23501)
...
### [28] [LATED: Ly$α$-anchored photometric selection of candidate metal-free and extremely metal-poor star formation from the end of reionisation to cosmic noon](https://arxiv.org/abs/2609.24588)
...
### [29] [XMST II: The spatial and kinematic structure of Galactic OB associations in Gaia DR3](https://arxiv.org/abs/2609.23515)
*Mark Gallaway*
...
### [30] [LATED: JWST integral field spectroscopy of a galaxy caught in chemical infancy at $z=4.8$ behind Abell 2744](https://arxiv.org/abs/2609.24589)
...
### [31] [EP-FXT observations of the cool-core cluster Abell 478 out to R200: Thermodynamic properties and azimuthal asymmetry](https://arxiv.org/abs/2609.23631)
...
### [32] [Age and Mass Signatures in the Multiband Second-order Image Structure of Young Star Clusters in M31](https://arxiv.org/abs/2609.23741)
...
### [33] [A Galactic-scale extreme-precision radial velocity survey](https://arxiv.org/abs/2609.23874)
...
### [34] [Galaxy sizes in the early Universe](https://arxiv.org/abs/2609.23911)
...
### [35] [Gas phase Elemental abundances in Molecular cloudS (GEMS) XII. First look into the para-to-ortho ratio of c-C3D2 towards prestellar cores](https://arxiv.org/abs/2609.24285)
...
### [36] [Gravity-driven Emergence of Multi-fractal Density Structure in the Orion A Integral Shaped Filament](https://arxiv.org/abs/2609.24319)
...
### [43] [Model-Independent Measurement of Baryon Gas Fractions through Galaxy-Galaxy Lensing and the Kinematic Sunyaev-Zel'dovich Effect](https://arxiv.org/abs/2609.22466)
...
### [44] [Stress-testing the spatially flat Universe: nonparametric spatial curvature determination from DESI DR2](https://arxiv.org/abs/2609.22470)
...
### [45] [Axio-Dilaton Dark Energy: A Dynamical Systems and Bayesian Inference Analysis](https://arxiv.org/abs/2609.22539)
...
### [46] [Hunting Thermal Relics in the DESI DR1 Ly$α$ Forest](https://arxiv.org/abs/2609.22581)
...
### [47] [Feeding the Void: Co-evolution of the SIDM-seeded Black Hole and the dark halo after core-collapse](https://arxiv.org/abs/2609.22758)
...
### [48] [Thermal-acoustic fermionic dynamics and primordial perturbations in warm Yukawa inflation](https://arxiv.org/abs/2609.23029)
...
### [49] [Impact on time delays due to milli-lensing by subhalos on lensed gravitational waves](https://arxiv.org/abs/2609.23428)
...
### [50] [Sound-Horizon-Independent Test of Cosmic Distance Duality Relation Using Artificial Neural Networks and Gaussian Processes](https://arxiv.org/abs/2609.24203)
...
### [51] [Probing modified gravity with galaxy-cluster-lensed gravitational-wave time delays: impact of systematic effects](https://arxiv.org/abs/2609.24351)
...
### [52] [Biases from Astrophysical Environmental Effects in Standard-Siren Cosmology](https://arxiv.org/abs/2609.24476)
...
### [53] [Merlin: Fast and flexible 3x2pt cosmology with simulation-based inference](https://arxiv.org/abs/2609.24946)
...
### [54] [Two-dimensional weak lensing shear for cluster mass, concentration, ellipticity and miscentering estimation](https://arxiv.org/abs/2609.24948)
...
### [55] [Tangled $τ$: Planck CMB Constraints on Flash Reionization](https://arxiv.org/abs/2609.24989)
...
### [56] [Multi-Stage and Multi-Field Inflation in Random Inflationary Landscapes](https://arxiv.org/abs/2609.24992)
