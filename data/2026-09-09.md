...
### [31] [Detection prospects for heavy WIMP dark matter around M31* in microwave band](https://arxiv.org/abs/2609.08771)
*Andrei E. Egorov*
...
### [32] [Origins of complex organic molecules in L1551 IRS 5: Interplay of thermal heating and accretion shocks](https://arxiv.org/abs/2609.07991)
...
### [33] [Weak cool core, weak turbulence: XRISM, XMM-Newton and Chandra spectroscopy of the core of Abell 1413](https://arxiv.org/abs/2609.08778)
...
### [34] [The Roman eXtreme Deep Field (RXDF)](https://arxiv.org/abs/2609.08145)
...
### [35] [Small-Scale Clustering of Primordial Black Holes: The Little Red Dot Mass Function and the High-Redshift Galaxy Tension](https://arxiv.org/abs/2609.09078)
...
### [36] [AEON-z5: A Candidate AGN-driven Outflow Enriching the Circumgalactic Medium at $z\simeq5.23$](https://arxiv.org/abs/2609.08264)
...
### [37] [Low-Redshift Interlopers in the SDSS DR16 $z > 5$ Quasar Catalogue](https://arxiv.org/abs/2609.08290)
...
### [38] [Series of core collapse numerical simulations (SOLANUM) I: Modelling the early and late infall in a sun-like protostar](https://arxiv.org/abs/2609.08376)
...
### [39] [The Impact of Circumgalactic Rotation on Ly$α$ Radiative Transfer](https://arxiv.org/abs/2609.08396)
...
### [40] [J023721.13$-$010528.5: A Giant $S$-shaped Radio Galaxy Showing Four Episodes of Jet Activity](https://arxiv.org/abs/2609.08506)
...
### [41] [The environmental dependence of the circumgalactic medium in a high-resolution cosmological simulation](https://arxiv.org/abs/2609.08654)
...
### [42] [Design and commissioning of a windowless gas-target system for high-current beams at JUNA](https://arxiv.org/abs/2609.08782)
...
### [43] [Turbulence Cascade in Cygnus X Revealed by Multi-point VDF Method](https://arxiv.org/abs/2609.08894)
...
### [44] [Euclid: Quick Data Release (Q1) -- Exploring the detailed visual morphology of galaxies in clusters](https://arxiv.org/abs/2609.08962)
...
### [45] [Triaxiality of the Milky Way dark matter halo and the microlensing optical depth towards the Large Magellanic Cloud](https://arxiv.org/abs/2609.08988)
...
### [46] [Closed-Form of the Local Galactic Potential and Stellar Distribution Function from Gaia DR3](https://arxiv.org/abs/2609.09011)
...
### [47] [Active galactic nucleus activity in brightest cluster galaxies at intermediate redshifts in Sunyaev-Zel'dovich--selected clusters](https://arxiv.org/abs/2609.09049)
...
### [49] [Exploring the dark sector through galaxy dynamics in clusters](https://arxiv.org/abs/2609.05597)
...
### [50] [Analytic bispectrum covariance for galaxy survey cosmology](https://arxiv.org/abs/2609.05607)
...
### [51] [How Cluster Pressure Profiles Scale: Mass, Redshift, and Intrinsic Scatter](https://arxiv.org/abs/2609.05612)
...
### [52] [Do DESI-DR2 BAO data imply a coupling of dark matter and dark energy?](https://arxiv.org/abs/2609.05660)
...
### [53] [Stacking HI in the dark: Towards detecting the reionization-epoch 21 cm signal in Lyman-$α$ dark gaps](https://arxiv.org/abs/2609.05980)
...
### [54] [Probing Dark matter-Baryon Interaction with S301--the Fastest Known Star in the Milky Way](https://arxiv.org/abs/2609.06184)
*Yugen Lin*
...
### [55] [Little Red Dot Cosmology: A Matter-Era Baryon Acoustic Oscillations Probe of $Λ$CDM](https://arxiv.org/abs/2609.06926)
...
### [56] [Primordial Black Hole Abundances and Scalar Induced Gravitational Waves from Finite-Width Power Spectra in a Stiff Thermal History](https://arxiv.org/abs/2609.07043)
...
### [57] [Conformally Interacting Dark Energy with Early and Late-Time Measurements](https://arxiv.org/abs/2609.07343)
...
### [58] [Recovering Large-Scale Clustering of Missing Galaxies for Galaxy--Gravitational-Wave Cross-correlations](https://arxiv.org/abs/2609.07348)
...
### [59] [Ultra-slow-roll Inflation with Non-perturbative Non-Gaussianity and Scalar Induced Gravitational Waves](https://arxiv.org/abs/2609.07401)
...
### [60] [Filament-Arm Node Systems (FANS): A new probe of the winding and chirality of the cosmic web](https://arxiv.org/abs/2609.07792)
...
### [61] [The SRG/eROSITA All-Sky Survey: Early dark energy and Hubble constant from the cluster mass function](https://arxiv.org/abs/2609.07834)
...
### [62] [Observation-driven simulations of strong lensing galaxy clusters](https://arxiv.org/abs/2609.07840)
...
### [63] [Non-linear Pairwise Velocities as a Cosmological Probe](https://arxiv.org/abs/2609.07976)
...
### [64] [Interacting fluid cosmologies from the metric-affine framework](https://arxiv.org/abs/2609.07978)
...
### [65] [Probing Projection Effects in Optically-Selected Clusters with Velocity Dispersions Outliers](https://arxiv.org/abs/2609.08095)
...
### [66] [Finding the distribution of matter using lenses - I: deconvolution-based reconstruction with CMB lensing](https://arxiv.org/abs/2609.08457)
...
### [67] [Finding the distribution of matter using lenses - II: deconvolution-based reconstruction with 3x2pt measurements](https://arxiv.org/abs/2609.08460)
...
### [68] [Vacuum Decay and Baryogenesis Associated with Primordial Black Holes at Finite Temperature](https://arxiv.org/abs/2609.08462)
*Qi Sun,Ligong Bian*
...
### [69] [Harnessing stellar kinematics to constrain dark energy with the double-source-plane gravitational lens SDSS J0946+1006](https://arxiv.org/abs/2609.08573)
...
### [71] [Why Azimuthal Averaging Works in Halo Lensing: Symmetry and Power Counting for Nonlinear Shear and Magnification](https://arxiv.org/abs/2609.08825)
*Keiichi Umetsu*
...
### [72] [Optical Depths from the Thermal Sunyaev-Zel'dovich Effect with ACT DR6 and DESI DR1 Spectroscopic Galaxies and Optically-Selected Clusters](https://arxiv.org/abs/2609.08939)
...
### [73] [TILING I: Field-level Bayesian reconstruction of cosmological initial conditions during the epoch of reionization](https://arxiv.org/abs/2609.09102)
...
### [74] [A Two-Dimensional Test of Cosmological Parity Violation with the 3-Point Correlation Function](https://arxiv.org/abs/2609.09106)
...
### [75] [Mitigating baryonic effects in weak lensing with higher-order statistics](https://arxiv.org/abs/2609.09131)
...
### [76] [Baryonification IV: Constraining baryonic feedback with X-ray gas fractions](https://arxiv.org/abs/2609.09144)
...
### [77] [Differential Polarization Calibration: A Consistency Test for Cosmic Birefringence](https://arxiv.org/abs/2609.09149)
...
### [78] [Sizing the Universe with DESI Galaxy Sizes: Plain Fundamentals of Fundamental-Plane Lensing](https://arxiv.org/abs/2609.09151)
