...
### [1] [Cosmic-ray electron propagation in NGC 3044 from radio continuum observations](https://arxiv.org/abs/2602.10574)
*Shengtao Wang,Xiaohui Sun,George Heald,Jiang-Tao Li,Chao-Wei Tsai,Judith Irwin,Theresa Wiegert,Jun Xu*

Main category: astro-ph.GA

TL;DR: Study of cosmic-ray electron transport and galactic wind in edge-on galaxy NGC 3044 using ASKAP radio observations reveals two exponential disk components, advection-dominated CRE transport with increasing velocity, and evidence for a superbubble structure.


<details>
  <summary>Details</summary>
Motivation: Edge-on star-forming galaxies show extended halo radiation, providing ideal conditions to study matter transfer from disk to halo. The paper aims to investigate cosmic-ray electron transport, associated galactic winds, and their impact on the surrounding medium in NGC 3044.

Method: Used Australian SKA Pathfinder (ASKAP) observations at 943 MHz with 16 arcsec resolution and 20 μJy beam⁻¹ sensitivity. Analyzed total intensity and spectral index profiles perpendicular to the disk, fitting with one-dimensional advection and diffusion models. Combined with multi-wavelength data (soft X-ray, HI, Hα) to identify superbubble structure.

Result: ASKAP intensity profiles show two exponential components with scale heights of 0.43±0.13 kpc (thin disk) and 1.91±0.26 kpc (thick disk). CREs are advected outward with velocity increasing with height in a power law. Beyond ~3 kpc, velocity exceeds escape speed (~400 km s⁻¹), indicating strong wind. Identified a possible superbubble (~3 kpc radius) filled with soft X-ray emitting hot gas, surrounded by HI shell and bright Hα rim.

Conclusion: Radio continuum observations are powerful probes of cosmic-ray-driven winds in normal star-forming spiral galaxies. The study demonstrates advection-dominated CRE transport with increasing velocity leading to strong galactic winds, and reveals multi-phase superbubble structure in NGC 3044.
...
### [2] [The metal-poor tail of the APOGEE survey I. Uncovering [Fe/H] < -2.5 stars from the inner Galaxy to the Magellanic Clouds](https://arxiv.org/abs/2602.10859)
...
TL;DR: Identification and orbital analysis of 289 very metal-poor red giant stars from APOGEE survey data, including Magellanic Cloud candidates and inner Galaxy populations.


<details>
  <summary>Details</summary>
Motivation: To identify stars below APOGEE's metallicity analysis limit and investigate their orbital properties to understand the distribution of very metal-poor stars and select targets for follow-up spectroscopy.

Method: Analyzed APOGEE pipeline outputs for metal-poor stars from literature to identify signatures of stars below the metallicity grid range; used calibrated APOGEE parameters (null metallicities with valid Teff/logg), literature comparison, and orbital computation using APOGEE radial velocities, Gaia DR3 astrometry, and spectrophotometric distances.

Result: Identified 289 very metal-poor red giant stars (likely [Fe/H] < -2.5) from APOGEE, including 16 Magellanic Cloud member candidates, 14 inner Galaxy confined stars, and 13 inner Galaxy halo interlopers; established that most APOGEE stars without calibrated metallicities (Teff: 3700-6700K, S/N > 30) are very metal poor.

Conclusion: APOGEE's calibrated stellar parameters provide clear signatures for identifying very metal-poor stars, enabling discovery of distinct populations including Magellanic Cloud members and inner Galaxy stars, with implications for understanding metal-poor star formation and Galactic archaeology.
...
### [3] [The metal-poor tail of the APOGEE survey II. Spectral analysis of Mg and Si in very metal-poor APOGEE spectra](https://arxiv.org/abs/2602.10883)
...
TL;DR: Researchers developed a specialized pipeline to measure metallicities for 327 very metal-poor stars using Mg and Si abundances from APOGEE spectra, overcoming limitations of standard pipeline analysis for extremely metal-poor stars.


<details>
  <summary>Details</summary>
Motivation: Standard APOGEE pipeline fails to properly analyze very metal-poor stars ([Fe/H] < -2) because H-band spectra contain weak Fe lines at these metallicities, requiring alternative abundance indicators.

Method: Designed specialized pipeline to measure Mg and Si abundances from APOGEE spectra, tested three different enhancement assumptions, and used these elements as proxies for overall metallicity in extremely metal-poor stars.

Result: Measured metallicities for 327 stars with typical uncertainties of 0.2 dex, extending metal-poor tail down to [M/H] = -3.1, identified 5 stars with unusual [Si/Mg] > 0.5, and found concentration of high [Si/Mg] stars in Sextans dwarf galaxy.

Conclusion: Mg and Si lines provide reliable metallicity estimates for extremely metal-poor stars in APOGEE spectra, enabling study of chemical signatures related to specific supernova events and galactic environments.
...
TL;DR: Benchmark study comparing PCA, ICA, wavelet-based iterative soft thresholding (IST), and 3D U-Net deep learning for denoising faint ALMA spectral cubes of high-redshift galaxies, finding IST robust for moderate-SNR data and U-Net effective with appropriate training priors.


<details>
  <summary>Details</summary>
Motivation: Faint galaxy signals beyond cosmic noon are crucial for understanding massive galaxy assembly but require robust denoising techniques to extract meaningful information from noisy ALMA observations of cold dust and [C II] emission.

Method: Evaluation of four denoising strategies: Principal Component Analysis (PCA), Independent Component Analysis (ICA), sparse unsupervised representations using iterative soft thresholding with 2D-1D wavelets (IST), and supervised deep learning with a 3D U-Net. Applied to synthetic rotating disk cubes, FIRE simulation [C II] cubes, and real ALMA observations of CRISTAL galaxies and W2246-0526.

Result: For synthetic cubes: PCA/ICA marginal improvement; IST effective at moderate SNRs but suppresses emission at low SNRs; U-Net outperforms IST but produces hallucinations at low SNRs. For moderate-SNR ALMA-CRISTAL: U-Net and IST comparable (>91% flux conservation, >6 SNR improvement). For complex morphology W2246: U-Net underperforms (~80% flux recovery) while IST robustly conserves flux and improves SNR by ~3.

Conclusion: IST is a robust unsupervised denoiser for moderate-SNR data, while synthetically trained U-Net generalizes effectively to real data but depends on training priors. The framework offers transferable denoising for ALMA, VLT/MUSE, and JWST observations.
...
### [5] [Most Strong Lensing Deflectors in the AGEL Survey are in Group and Cluster Environments](https://arxiv.org/abs/2602.11068)
...
TL;DR: Analysis of 89 strong lenses from AGEL survey reveals most deflectors (47.2%) are in cluster environments but only 9.0% have cluster-scale Einstein masses, showing weak correlation between Einstein mass and environment density, challenging single-galaxy deflector assumptions in lens modeling.


<details>
  <summary>Details</summary>
Motivation: Deflector environments in strong lensing systems affect cosmological model testing and galaxy evolution constraints, requiring quantification of how environment influences lensing properties and modeling assumptions.

Method: Analyzed 89 spectroscopically confirmed strong lenses from AGEL survey, measuring deflector scale via Einstein radius θ_E and Einstein mass M(<θ_E), and environment via photometric redshifts to determine galaxy surface density Σ_5(z) to fifth-nearest neighbor.

Result: 47.2% of deflectors in cluster environments but only 9.0% have cluster-scale Einstein masses; weak correlation (r=0.38) between Einstein mass and Σ_5(z); AGEL deflectors in systematically denser environments than control fields.

Conclusion: Single galaxy-scale deflector assumption in lens modeling is overly simplified; environment significantly affects lensing properties; provides method to identify lenses by environment and approximate environmental impact in modeling.
...
### [6] [Beyond $Λ$CDM: fundamental constants as cosmological observables](https://arxiv.org/abs/2602.10987)
*Dinko Milaković,John K. Webb*

Main category: astro-ph.CO

TL;DR: WST spectroscopic facility could produce over 100,000 quasar and 1 million galaxy measurements of fine-structure constant α to constrain physics beyond ΛCDM, addressing cosmological tensions through fundamental constant variations.


<details>
  <summary>Details</summary>
Motivation: Cosmological tensions challenge ΛCDM, but forthcoming facilities primarily probe gravitational interactions with limited non-gravitational information. Observational constraints on spacetime variations of fundamental constants provide complementary tests to distinguish between competing models with similar predictions but different underlying principles.

Method: Measure fine-structure constant α using absorption systems toward bright quasars via Many Multiplet method and atomic doublets from line-emitting gas in galaxies. A spectroscopic facility like WST could produce >100,000 quasar measurements and ~1 million galaxy measurements.

Result: Large, homogeneous dataset of α measurements would provide unprecedented constraints on physics beyond ΛCDM when combined with other cosmological probes.

Conclusion: Variations in fundamental constants offer crucial complementary tests to gravitational probes for distinguishing between competing cosmological models and addressing ΛCDM tensions.
...
### [7] [Beyond thermal approximations: Precise cosmological bounds on Axion-Like Particles](https://arxiv.org/abs/2602.11100)
*Nicola Barbieri,Luca Caloni,Martina Gerbino,Massimiliano Lattanzi,Luca Visinelli*

Main category: astro-ph.CO

TL;DR: Updated cosmological constraints on light axion-like particles (ALPs) using full phase-space treatment of thermal production and modern CMB+BBN data, with forecasts for future CMB experiments.


<details>
  <summary>Details</summary>
Motivation: To derive improved cosmological bounds on ALPs by properly accounting for their non-thermal phase-space distributions from primordial thermal production, which affects ΔN_eff calculations and thus cosmological observables.

Method: Solve momentum-dependent Boltzmann equations for ALP production processes, propagate phase-space distributions into cosmological observables, use Planck/ACT/SPT CMB data plus BBN deuterium/helium abundances, and include DESI BAO data for comparison.

Result: 95% credible limits: f_a > 1.63×10⁶ GeV (e-coupling), 9.41×10⁶ GeV (μ-coupling), 8.06×10⁴ GeV (τ-coupling); g_{aγ} < 1.98×10⁻⁸ GeV⁻¹. DESI BAO data mildly relaxes constraints. Forecasts show LiteBIRD+SO and LiteBIRD+CMB-HD will significantly improve sensitivity.

Conclusion: Full phase-space treatment is essential for robust ALP constraints; current data provides stringent limits on ALP-lepton and ALP-photon couplings; future CMB experiments will substantially improve sensitivity to ALP interactions.
...
### [8] [Massive stars as gravitationally lensed transients -- Insights on the high-mass initial mass function](https://arxiv.org/abs/2602.10909)
*Sung Kei Li*

Main category: astro-ph.CO

TL;DR: The paper presents a method using transient lensed stars to probe the stellar initial mass function (IMF) in distant galaxies, finding no evidence for a top-heavy IMF at z≈1.


<details>
  <summary>Details</summary>
Motivation: Direct measurement of the stellar IMF is limited to the local universe due to telescope resolution constraints. A new method is needed to study IMF in distant galaxies to understand star formation processes beyond our cosmic neighborhood.

Method: Uses detection rates of transient lensed stars - individual massive stars in strongly lensed galaxies that become temporarily detectable through stellar microlensing. This breaks the IMF-star formation history degeneracy in spectral energy distribution fitting studies.

Result: Current results show no evidence for a top-heavy IMF in galaxies at redshift z≈1, suggesting the IMF in these distant galaxies is similar to the local IMF.

Conclusion: The method provides a promising window to study IMF in gravitationally lensed galaxies beyond the local universe, with initial findings indicating IMF properties at z≈1 are consistent with local measurements.
