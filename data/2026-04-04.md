...
TL;DR: JWST study maps ionized gas in ~200 galaxies at z~3, finding AGN hosts have larger ionized gas extents than control galaxies, with correlation between gas extent and AGN luminosity suggesting AGN dominate ionization at Cosmic Noon.


<details>
  <summary>Details</summary>
Motivation: To understand how AGN and stellar ionization shape the gaseous reservoirs of galaxies during Cosmic Noon (z≈2-3) when both star formation and AGN activity peaked, by studying the spatial distribution of ionized gas.

Method: Used JWST/NIRCam imaging from JEMS to spatially map [O III]+Hβ and Paβ emission in ~200 galaxies at 2.5<z<2.9. Applied multiwavelength AGN diagnostics to classify galaxies into AGN hosts (33), Paβ-detected systems (32), and control objects (175). Measured spatial extents and related them to AGN/host properties from SED modeling.

Result: Both tracers show systematically larger maximum radial extents in AGN hosts than control galaxies (~0.3 dex), with [O III]+Hβ modestly more extended than Paβ (~0.1 dex). Measured [O III]+Hβ radial extent-AGN luminosity relation at z~3 with slope ~0.2, consistent with shallow end of low-z values.

Conclusion: AGN activity may dominate gas ionization in galaxies with mixed AGN and star-forming activity at Cosmic Noon, though stellar processes still contribute significantly on kiloparsec scales, as evidenced by larger ionized gas extents in AGN hosts and correlation with AGN luminosity.
...
TL;DR: GCE models of ³He tend to overpredict observed abundances even with lowest AGB yields; require slow star formation onset or stronger outflows to match data, suggesting possible missing mixing physics in stellar models.


<details>
  <summary>Details</summary>
Motivation: To understand galactic chemical evolution of ³He and reconcile discrepancies between stellar model predictions and observed abundances (protosolar and Orion nebula measurements).

Method: Use one-zone and multi-zone GCE models constrained by observed [O/H], incorporating metallicity-dependent AGB yields with extra mixing processes (rotational, thermohaline), and varying IMF-averaged oxygen yields and star formation parameters.

Result: Even with lowest AGB yields, models overpredict ³He abundances; require slow star formation onset and low efficiency or stronger outflows (with higher oxygen yield) to match observations, suggesting true yields may be lower than current stellar models predict.

Conclusion: Current stellar models may overestimate ³He production; missing mixing physics in red giants could explain discrepancies. Future measurements in higher metallicity environments could help distinguish between GCE parameter solutions and yield uncertainties.
...
TL;DR: The paper demonstrates that the predicted 'tree-ring' structure in phase space, formed by stars trapped in the Milky Way's bar corotation resonance during bar spin-down, persists in realistic N-body simulations despite various perturbations including spiral arms and satellite galaxy encounters.
...
Result: The predicted tree-ring structure emerges and remains well-preserved in slow angle-action space despite the presence of spiral arms, Sagittarius dwarf galaxy encounters, fluctuations in the bar's pattern speed, and numerical noise. The structure is robust against stellar diffusion in phase space.
...
TL;DR: Systematic IFS analysis of 990 low-mass galaxies reveals 41 AGN signatures (4% fraction), plus 46 candidates, demonstrating IFS superiority over single-fiber spectroscopy for detecting extended/off-nuclear BH accretion.


<details>
  <summary>Details</summary>
Motivation: To identify accreting black holes in low-mass galaxies using IFS, as these host the smallest supermassive black holes that constrain BH seed formation, and to overcome limitations of single-fiber spectroscopy which may miss extended emission.
...
Result: Found 41 galaxies with clear AGN signatures and 46 less secure candidates, spanning stellar masses 10^9.4-10^10 M⊙ (down to 10^8.5 M⊙ including candidates), z < 0.06, and diverse morphologies. AGN fraction of 4% (9% including candidates) significantly exceeds single-fiber studies (≤1-2%).

Conclusion: IFS enables more complete AGN detection in low-mass galaxies by capturing extended/off-nuclear emission, revealing higher AGN fractions than previously reported and highlighting the importance of spatially resolved spectroscopy for studying BH accretion in dwarf galaxies.
...
TL;DR: Lecture notes from 2025 Saas-Fee course on JWST observations of galaxies and black holes in the first billion years, covering theory, challenges to ΛCDM, and modeling approaches.


<details>
  <summary>Details</summary>
Motivation: To provide early career researchers with comprehensive understanding of galaxy formation theory in the first billion years, addressing whether JWST observations challenge the ΛCDM paradigm and discussing necessary model revisions.

Method: Lectures covering cosmological structure formation, dark matter halo properties at z≳6, physical processes, simulation-to-observable translation techniques, and modeling approaches for high-redshift galaxy formation.
...
Conclusion: JWST observations present significant puzzles that may require revisions to current galaxy formation models, highlighting the need for continued theoretical development to reconcile observations with the ΛCDM paradigm.
...
TL;DR: DESI DR2 analysis decomposes Milky Way stellar halo into metal-rich (GSE-dominated) and metal-poor (minor merger) components, revealing their distinct chemical/kinematic properties and quantifying LMC-induced perturbations in the outer halo.


<details>
  <summary>Details</summary>
Motivation: To quantitatively characterize the Milky Way's stellar halo structure by decomposing it into distinct populations, understand the contributions from major (GSE) and minor mergers, and measure the ongoing dynamical response to the Large Magellanic Cloud's infall.

Method: Used 64,000 halo K giants from DESI DR2, applied Gaussian mixture model to decompose halo into metal-rich and metal-poor components between 3-160 kpc, analyzed chemical/kinematic properties, and quantified non-equilibrium motions using dipole-plus-contraction velocity field.

Result: Found two nearly equal populations: metal-rich stars (beta~0.94, sigma([Fe/H])~0.17 dex) from GSE dominate inner 30 kpc and extend to 70-80 kpc; metal-poor stars (beta~0.46 decreasing to -0.5, sigma([Fe/H])~0.46 dex) show minor merger signatures. Outer halo contracts at ~-19 km/s with LMC-induced reflex motions increasing from -19 to -44 km/s with radius.

Conclusion: The study provides distance-resolved characterization of the Milky Way's last major accretion (GSE) and quantifies the ongoing dynamical response to LMC infall, revealing distinct chemical/kinematic signatures of different merger populations and LMC-induced perturbations throughout the outer halo.
...
TL;DR: Modified gravity theory with Weyl tensor-stress-energy tensor coupling explains galactic rotation curves without dark matter, using realistic variable density profiles for multiple galaxies.


<details>
  <summary>Details</summary>
Motivation: To test a modified gravity theory that eliminates the need for exotic dark matter by explaining flat galactic rotation curves through a coupling between the Weyl tensor and stress-energy tensor, moving beyond previous constant-density models.
...
Conclusion: The modified gravity approach with Weyl tensor coupling provides a viable alternative to dark matter for explaining galactic rotation curves when using realistic density distributions.
...
TL;DR: Bar formation in cluster galaxies occurs primarily during pericenter passages around BCG progenitors, with diverse formation mechanisms and timing spanning 3-11 Gyr.


<details>
  <summary>Details</summary>
Motivation: To understand the formation and evolution of bars in cluster galaxies, specifically examining the diverse pathways and environmental influences in the high-density cluster environment.

Method: Analysis of 15 bar-like galaxies from the most massive cluster in TNG50 simulation, focusing on galaxies with strongly prolate stellar components from well-resolved subhalos.

Result: 11/15 galaxies form/enhance bars during pericenter passages around BCG progenitors; 2 form early via minor mergers; 1 via massive galaxy interaction; 1 via disk instability. Bar lengths (2-6 kpc) don't correlate with tidal forcing. Most bar formation occurs before BCG assembly, with diverse orbital histories.

Conclusion: Bar formation in clusters follows multiple pathways with complex coevolution with BCG progenitors, emphasizing the importance of environmental interactions and diverse evolutionary histories in cluster environments.
...
<details>
  <summary>Details</summary>
Motivation: To understand stellar assembly in elliptical galaxy cores and test formation scenarios using gravitational lensing to probe stellar populations at high redshift.

Method: Used gravitational lensing of a quadruply imaged quasar (radius ~0.2") with lens galaxy at z=1.055, combined Bayesian analysis with standard scaling relations to sample central galactic initial mass function.

Result: Found lensing galaxy mass ~2×10¹⁰ M☉, central IMF consistent with Milky Way type (excluding bottom-heavy functions), suggesting slow core growth or early disruptive events.

Conclusion: Elliptical galaxy cores may form differently than classical rapid bulge formation models, potentially through slower assembly or early disruptive events altering stellar build-up.
...
### [10] [SDSS J153231.80+420342.7: a triple black hole candidate with a close binary black hole](https://arxiv.org/abs/2604.02161)
*Qi Zheng,YiWen Jiang,Xue-Guang Zhang,Qirong Yuan*

Main category: astro-ph.GA

TL;DR: Discovery of a triple black hole candidate in quasar SDSS J1532 featuring dual AGN signatures at ~3 kpc separation and optical QPOs suggesting a close binary black hole at ~1 mpc separation.


<details>
  <summary>Details</summary>
Motivation: To identify and characterize potential multiple black hole systems in active galactic nuclei, particularly focusing on the rare case of a triple black hole system, which could provide insights into galaxy merger evolution and black hole dynamics.

Method: Analysis of SDSS J1532 using spectroscopic data showing double-peaked narrow emission lines for dual AGN detection, combined with photometric monitoring from ZTF and CSS revealing optical quasi-periodic oscillations to infer close binary black hole properties.

Result: Identified a triple black hole candidate with: 1) dual AGN signatures at ~3 kpc separation based on double-peaked narrow emission lines, and 2) optical QPOs of ~0.6 yr period lasting >14 years suggesting a close binary black hole at ~1 mpc separation. Alternative explanations (rotating NLR, outflows, disk/jet precession) cannot be completely ruled out.

Conclusion: SDSS J1532 represents a promising triple black hole candidate potentially undergoing critical evolutionary phase, with kpc-scale dual AGN and mpc-scale close binary black hole components, though alternative interpretations remain possible.
...
### [11] [Euclid preparation. Non-Gaussianity of 2-pt statistics likelihood: Parameter inference with a non-Gaussian likelihood in Fourier and configuration space](https://arxiv.org/abs/2604.01309)
...
TL;DR: The paper shows that for Euclid spectroscopic survey 2-point statistics, the Gaussian likelihood assumption is robust despite potential skewness concerns, with cosmological constraints unchanged when using Edgeworth expansion.


<details>
  <summary>Details</summary>
Motivation: To address concerns about non-Gaussianity in cosmological parameter inference from large-scale structure surveys, specifically whether skewness in likelihood distributions could bias constraints from Euclid 2-point statistics.

Method: Model likelihood through Edgeworth expansion involving complete skewness tensor (1-, 2-, 3-point correlators), simplify calculations via basis change that reduces precision matrix to identity, test with 10,000 cloned Euclid mocks based on realistic galaxy catalogs.

Result: Off-diagonal elements of skewness tensor consistent with zero, diagonal amplitudes match Gaussian field expectations; including only diagonal skewness sufficient, full tensor injects noise without improving accuracy; cosmological constraints unchanged between Gaussian likelihood and Edgeworth expansion (<5% variation in FoM); no detectable excess skewness on intermediate scales due to Euclid shot noise level.

Conclusion: Gaussian likelihood assumption is robust for Euclid 2-point statistics analyses in both Fourier (power spectrum) and configuration (correlation function) space, regardless of survey volume/geometry, scale-cuts, or specific 2-point statistic used.
...
TL;DR: Primordial black hole clustering explains JWST's "little red dots" as supermassive black holes via successive PBH mergers solved with Smoluchowski coagulation equation and Monte Carlo simulations.
...
Method: Comprehensive simulation of successive PBH mergers within clusters using Smoluchowski coagulation equation, deriving coagulation kernels with/without mass segregation effects, and solving via Monte Carlo method with full-conditioning scheme using discrete inverse transformation method.

Result: Simulations determine runaway timescales of clusters and mass population evolution of PBHs across wide range of cosmic redshifts, depending on PBH number within cluster and associated density.

Conclusion: Primordial black hole clustering provides viable explanation for JWST's high-redshift supermassive black hole observations through successive merger processes.
...
TL;DR: The paper investigates cosmological imprints of the Generalized Uncertainty Principle (GUP) using redshift-space distortion data, revealing negative deformation parameter β values with ΛCDM within 95% confidence intervals.


<details>
  <summary>Details</summary>
Motivation: To explore the cosmological consequences of the Generalized Uncertainty Principle, particularly how the existence of a minimal length scale (predicted by quantum gravity theories) affects late-time structure formation and dark energy dynamics in the universe.

Method: Modified Poisson bracket formalism incorporating minimal length leads to modified Raychaudhuri equation within ΛCDM framework, creating one-parameter dynamical dark energy model. Used f and fσ₈ growth rate measurements from redshift-space distortions combined with background data: cosmic chronometers, baryon acoustic oscillations, and Type Ia supernovae.

Result: Observational constraints yield systematically negative values for deformation parameter β, with ΛCDM limit within 95% credible interval. Model comparison shows weak-to-strong support for GUP-modified model depending on SNIa catalog (Akaike Information Criterion), while Bayesian evidence indicates weak preference.

Conclusion: The Generalized Uncertainty Principle leaves detectable imprints on cosmological scales, particularly affecting late-time structure formation. The negative β values suggest specific quantum gravity signatures, though ΛCDM remains statistically compatible. The approach provides a phenomenological framework to test quantum gravity effects through cosmological observations.
...
TL;DR: Study examines observational signatures of traversable wormholes in binary systems, analyzing acceleration perturbations and radial velocity changes to distinguish wormholes from black holes or triple systems.


<details>
  <summary>Details</summary>
Motivation: To identify observable signatures that could distinguish traversable wormholes from other astrophysical objects like black holes or triple star systems, addressing the challenge of detecting wormholes through their gravitational effects on companion stars.

Method: Analyzes two binary system models: 1) supermassive black hole as wormhole candidate with companion star perturbed by object on other side of wormhole throat, comparing acceleration to stochastic stellar influences; 2) wide binary system with wormhole, analyzing radial velocity changes compared to black hole binary and triple system models using spectral and non-parametric methods.

Result: For 1.5 km/s radial velocity accuracy, perturbations are detectable across all observation times; for 10 km/s accuracy, spectral analysis becomes statistically significant after ~17 years of data. Spectral and non-parametric methods significantly reduce required observation time compared to matched-filtering alone.

Conclusion: Traversable wormholes could produce detectable observational signatures in binary systems through radial velocity perturbations, with spectral analysis methods enabling detection within reasonable observation timescales, potentially distinguishing wormholes from black holes or triple systems.
...
TL;DR: DESI results suggest dynamical dark energy; GRB correlations test DE evolution to z~9 using calibrated Combo correlation with SN Ia data and Bézier interpolation, finding H₀~70 km/s/Mpc (alleviates Hubble tension) and no significant evidence for dynamical DE beyond cosmological constant.


<details>
  <summary>Details</summary>
Motivation: To test whether dark energy exhibits dynamical behavior (as suggested by DESI) using gamma-ray burst correlations calibrated with nearby supernovae, and to investigate the evolution of the dark energy equation of state up to high redshifts (z~9).

Method: 1. Use updated GRB catalog fulfilling Combo correlation; 2. Calibrate with three SN Ia catalogs at z≤0.075; 3. Employ Bézier interpolation of Hubble rate (alternative to cosmographic series); 4. Adopt model-independent, redshift-binned DE parametrization; 5. Explore impact of spatial curvature in both calibration and DE reconstruction.

Result: 1. Calibrated Combo correlation yields H₀~70 km/s/Mpc, alleviating Hubble tension; 2. Spatially curved scenarios disfavored; 3. Apparent 'phantom' behavior at z≲0.55 due to limited statistics; 4. At z>0.55, statistically robust evidence favors cosmological constant scenario; 5. No significant evidence for dynamical DE.

Conclusion: GRBs as distance indicators are consistent with current cosmic distance ladder. The Combo correlation alleviates Hubble tension and shows no significant evidence for dynamical dark energy, supporting the cosmological constant scenario at higher redshifts despite apparent phantom behavior at low-z due to statistical limitations.
...
TL;DR: A non-minimally coupled quintessence model explains DESI's observed late-time dark energy weakening through modified dark matter evolution that creates effective phantom crossing without actual scalar field crossing.


<details>
  <summary>Details</summary>
Motivation: To explain recent DESI measurements showing late-time weakening of dark energy dynamics, addressing the observed onset of dark energy weakening when it begins to dominate the universe.

Method: Proposes a new non-minimally coupled quintessence model where the coupling modifies dark matter evolution, creating effective phantom crossing behavior in observations while the scalar field remains canonical and never crosses the phantom divide.

Result: The model better fits current cosmological data compared to both ΛCDM and w₀wₐCDM models, with the coupling inducing sign changes in effective energy transfer between dark matter and dark energy during cosmic evolution.

Conclusion: Provides a promising framework for understanding the observational late-time weakening of dark energy and the origin of its dynamics through non-minimal coupling effects.
...
TL;DR: The paper analyzes gravitational wave amplitude and phase fluctuations from wave optics lensing with both strong and weak lenses, showing that consistency relations remain unchanged when a strong lens is present.


<details>
  <summary>Details</summary>
Motivation: To understand how gravitational wave signals are affected by combined strong and weak lensing effects in wave optics regime, and to determine whether established consistency relations for weak lensing alone remain valid when a strong lens is present.

Method: Apply geometric optics approximation to the strong lens and treat weak lensing potential perturbatively to obtain amplification factor up to second order in weak lensing potential. Develop systematic methodology using diagrammatic rules to evaluate weak lensing effects.

Result: Consistency relations originally established for weak lensing without a strong lens still hold in exactly the same form when a strong lens is present. Both magnification of the signal and shift of the Fresnel scale to larger scales occur for the mean weak lensing signal.

Conclusion: The presence of a strong lens does not alter the fundamental consistency relations for weak lensing effects on gravitational waves, and systematic diagrammatic methods can effectively analyze combined strong+weak lensing scenarios in wave optics regime.
...
TL;DR: Persistence strips, a novel topological representation of cosmic web structure, provide enhanced sensitivity to neutrino mass by breaking degeneracies with other cosmological parameters, achieving constraints of 0.05 eV from total matter and 0.13 eV from dark matter-only fields.


<details>
  <summary>Details</summary>
Motivation: Traditional cosmological probes of neutrino mass suffer from degeneracies with other parameters. The authors aim to develop more sensitive, degeneracy-breaking methods using topological analysis of cosmic structure to advance understanding of both particle physics and cosmic evolution.

Method: Introduce persistence strips - a novel representation that segments Betti curves by topological persistence, condensing 2D persistence diagrams into 1D curves. Apply persistent homology to FLAMINGO cosmological simulations, construct an emulator spanning 10-dimensional w₀wₐCDM+ν parameter space, and analyze both total matter and dark matter-only fields.

Result: Persistence strips achieve neutrino mass constraints of 0.05 eV for total matter field and 0.13 eV for dark matter-only field from only (350 Mpc)³ volume. They show roughly twice the constraining power of unbinned Betti curves and systematically break degeneracies with other parameters. Void topology provides strongest constraints, with signal originating from both neutrino mass fraction sensitivity (highest in underdense regions) and neutrino impact on dark matter distribution.

Conclusion: Topological statistics, particularly persistence strips, offer powerful degeneracy-breaking sensitivity to neutrino mass, with particular promise for weak lensing measurements that directly probe total matter distribution. The method identifies specific physical origins of the neutrino mass signal in cosmic web topology.
